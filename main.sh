...
#biocLite("DESeq2")
####################################################################################################
#one of the libraries is not working, workaround:
...
INPUT_COUNTS<-"c:\\Marek\\inf\\Bi5444\\Bi5444_R_analysis\\All_plain_counts.counts" 
OUTPUT_DIR<-"c:\\Marek\\inf\\Bi5444\\Bi5444_R_analysis\\Mirna_results"
